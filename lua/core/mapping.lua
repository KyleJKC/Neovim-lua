...
local def_map = {
    ...
    ["n|<A-a>"]      = map_cmd('<C-w>h'):with_noremap(),
    ...
    ["n|W"]          = map_cmd('5k'):with_noremap(),
    ["n|S"]          = map_cmd('5j'):with_noremap(),
    ["n|A"]          = map_cmd('5h'):with_noremap(),
    ["n|D"]          = map_cmd('5l'):with_noremap(),
    ["n|e"]          = map_cmd('i'):with_noremap(),
    ["n|c"]          = map_cmd('d'):with_noremap(),
    ["n|<Leader>fe"] = map_cmd(':NvimTreeToggle<CR>'):with_noremap(),

  -- Insert
    ["i|<C-q>"]      = map_cmd('<Esc>:q<CR>'),
--    ["i|<C-s>"]      = map_cu('write'):with_noremap(),
  -- Visual
